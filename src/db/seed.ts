...
const jobSeed = [
  {
    ...
    salaryMax: 28,
    summary:
      "Lead the web experience for a fast-growing SaaS platform used by 40,000+ businesses. React, TypeScript and a genuine say in product direction.",
    description:
      "You'll own the customer-facing web app end to end — from architecture decisions to the last pixel. The team is small, senior and ships weekly. You'll work directly with the founders on roadmap priorities and mentor two junior engineers as the product scales.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 22,
    summary:
      "Build the APIs and event pipelines behind a platform processing millions of requests a day. Fully remote, async-first culture.",
    description:
      "We're looking for a backend engineer who loves clean domain modelling and boring, reliable systems. You'll design services in Node.js and Postgres, write integration tests that catch real bugs, and help keep p99 latency under 200ms as traffic doubles.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 16,
    summary:
      "Six-month contract (extendable) to build out Playwright-based end-to-end coverage across two flagship products.",
    description:
      "A contract role for someone who treats flaky tests as a personal insult. You'll stand up a Playwright suite from near-zero, wire it into CI, and leave behind a framework the in-house team can maintain.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 16,
    summary:
      "Turn lending data into decisions. SQL-heavy role partnering with credit risk and product teams at a well-funded NBFC.",
    description:
      "You'll be the analyst for our lending book — building dashboards leaders actually read, designing experiments on pricing and limits, and digging into cohort performance when numbers move. High-ownership seat with direct exposure to the leadership team.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 26,
    summary:
      "Own AWS infrastructure, Kubernetes clusters and deployment pipelines for a regulated fintech processing high-volume transactions.",
    description:
      "Security-minded DevOps engineer to run our cloud footprint: Terraform-managed AWS, EKS workloads, and compliance-aware deployment practices. You'll work closely with engineering leads to keep releases safe, fast and auditable.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 9,
    summary:
      "Join a 300-bed multispecialty hospital's ICU team. Rotational shifts, structured training and a strong nursing culture.",
    description:
      "We're expanding our critical-care unit and hiring staff nurses who want real clinical growth. You'll work alongside experienced intensivists, with sponsored ACLS/BLS certification and clear progression to senior roles.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 14,
    summary:
      "Partner with clinical leadership on staffing, engagement and retention for a 1,200-person hospital workforce.",
    description:
      "An HRBP role with a difference: your stakeholders are doctors, nurses and technicians. You'll own workforce planning for clinical units, run engagement programmes that reduce attrition, and coach unit heads on people decisions.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 11,
    summary:
      "Run a 40-person assembly shift for an automotive components manufacturer. Lean mindset, safety-first leadership.",
    description:
      "You'll own daily production targets, line balancing and quality gates for a precision assembly line. The plant is modernising fast — expect exposure to automation upgrades and lean transformation projects.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 22,
    summary:
      "Own P&L for a top-3 category at a leading e-commerce marketplace. Vendor strategy, pricing and assortment — full ownership.",
    description:
      "This is a business-owner role: you'll set the strategy for Home & Living, negotiate with national brands, and work with growth and supply-chain teams to hit ambitious GMV targets. Ideal for someone from marketplace category management or top-tier consulting.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 14,
    summary:
      "Lead paid acquisition for a portfolio of D2C brands at an independent creative agency. ₹2Cr+ monthly budgets, real creative freedom.",
    description:
      "You'll run performance strategy for 4–6 D2C clients: media planning, creative testing pipelines and CRO experiments. The agency pairs media buyers with its in-house studio, so your tests get great creative fast.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 15,
    summary:
      "Design digital experiences for consumer brands — from campaign sites to full product redesigns. Portfolio-first evaluation.",
    description:
      "A designer who thinks in systems and sweats micro-interactions. You'll work across brand and product projects, present to clients directly, and see your work ship fast. We review portfolios, not pedigree.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 8,
    summary:
      "Guide students and parents toward the right programmes at a growing ed-tech. Empathy + targets, in equal measure.",
    description:
      "You'll speak with prospective learners, understand their goals, and match them to programmes where they'll genuinely succeed. Backed by a strong training team and a no-pressure, consultative sales culture.",
    responsibilities: [
  ...
  },
  {
    ...
    salaryMax: 6,
    summary:
      "Be the face of a boutique luxury property. Freshers from hospitality programmes welcome — grooming and training provided.",
    description:
      "A front-of-house role at a 60-room boutique hotel loved for its service. You'll handle check-ins, guest requests and the small surprises that turn a stay into a story. Structured training and rapid growth into duty management.",
    responsibilities: [
...
const blogSeed = [
  {
    ...
    excerpt:
      "Slow hiring loses great candidates. Here are five structural fixes that speed things up while raising the bar — from sharper role definitions to tighter interview loops.",
    category: "Hiring",
    readMinutes: 6,
    authorName: "Tranquil Peeplz Editorial",
    coverImage:
      "https://images.pexels.com/photos/5439447/pexels-photo-5439447.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
...
Track stage-by-stage conversion and time-in-stage. You can't fix what you haven't named — and in most funnels, the biggest leak is a stage nobody owns.`,
  },
  {
    ...
    excerpt:
      "The strongest teams blend permanent hires with contract talent deliberately. A practical framework for deciding which roles to staff flexibly — and which to anchor.",
    category: "Staffing",
    readMinutes: 5,
    authorName: "Tranquil Peeplz Editorial",
    coverImage:
      "https://images.pexels.com/photos/7693729/pexels-photo-7693729.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
...
Flexibility has a price: onboarding overhead, knowledge leakage, and the management attention contractors require. A healthy mix is usually 70–85% permanent core, with flexible layers around it — but let your demand curve, not habit, set the ratio.`,
  },
  {
    ...
    excerpt:
      "Salaries are stabilising, hybrid is the default, and candidates are choosing culture over brand names. Notes from the front lines of India's busiest hiring market.",
    category: "Insights",
    readMinutes: 7,
    authorName: "Tranquil Peeplz Editorial",
    coverImage:
      "https://images.pexels.com/photos/9301835/pexels-photo-9301835.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",
...
Roughly half of accepted offers in hot segments now trigger counteroffers. The antidote is engagement between offer and joining day: a welcome note from the manager, early invites to team rituals, and a clear 30-60-90 plan. The notice period is where offers go to die — guard it.`,
  },
  {
    ...
    excerpt:
      "Most interviews measure confidence, not competence. A well-designed scorecard fixes that. Here's a structure we've seen work across industries.",
    category: "Hiring",
    readMinutes: 5,
    authorName: "Tranquil Peeplz Editorial",
    coverImage:
      "https://images.pexels.com/photos/4344878/pexels-photo-4344878.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=627&w=1200",

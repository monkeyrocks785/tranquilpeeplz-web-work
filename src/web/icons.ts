...
export function icon(name: string, cls = "", size = 18): string {
...
export function instagramIcon(size = 17): string {
...
export function linkedinIcon(size = 17): string {
...
export function stamp(cls = ""): string {

...
function linesToArray(raw: string | undefined): string[] {
  if (!raw) return [];
  return raw
    .split("\n")
...
export type SubmitJobResult =
  | { ok: true; jobId: string; companyName: string }
...
export async function submitJobApplication(
  ...
  return {
    ok: true,
    message:
      "Application sent — our recruiters have your details and will reach out directly.",
  };
}

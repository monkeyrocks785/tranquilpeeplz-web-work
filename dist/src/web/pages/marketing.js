...
function ctaBand(p) {
  ...
  ${rv(`<div class="relative overflow-hidden rounded-[2.5rem] bg-pine px-8 py-16 text-center text-cream md:py-20">
...
export function aboutPage() {
    const ping = [
        ...
        .map((x, i) => rv(`<div class="text-center">
    ...
    const principles = [
        ...
        .map((x, i) => rv(`<div class="card-hover h-full rounded-[1.75rem] border border-ink/10 bg-cream p-8 text-center">
    ...
    const values = [
        ...
        .map((v, i) => rv(`<div class="flex gap-4">
    ...
    const milestones = [
        ...
        .map((m, i) => rv(`<div class="relative border-t border-cream/15 pt-6">
...
export function forEmployerPage() {
    const models = [
        ...
        .map((m, i) => rv(`<div class="card-hover h-full rounded-[1.75rem] border border-ink/10 bg-paper p-8">
    ...
    const steps = [
        ...
        .map((s, i) => rv(`<div class="card-hover flex gap-6 rounded-3xl border border-ink/10 bg-cream p-6 md:p-7">
    ...
    return `${hero({
        ...
        intro: "Your team is your strategy. We help you build it — with staffing that flexes, permanent hiring that sticks, and a truly consultative partner in between. Share a requirement today; it goes live after a quick review.",
...
export function forJobSeekerPage(p) {
    const support = [
        ...
        .map((s, i) => rv(`<div class="card-hover h-full rounded-[1.75rem] border border-ink/10 bg-paper p-7">
    ...
    const faqs = [
        ...
        .map((f, i) => rv(`<details class="group rounded-3xl border border-ink/10 bg-cream p-6 open:border-pine/40">
        ...
        </details>`, { delay: 0.05 * i }))
        .join("");
    return `${hero({
        eyebrow: "For Job Seekers",
        title: `Your next role is<br/>already <span class="italic-pop">looking for you</span>`,
        intro: "Great careers aren't found in infinite scroll. Browse approved roles, share your details once, and our recruiters stay with you through every round — no accounts, no noise. We're here to open doors to your next possibility.",
...
export const SERVICE_PAGES = [
    {
        ...
        intro: "Short-term cover, seasonal ramps or long-haul projects — our staffing solutions deliver vetted, productive people on your schedule, so your business never waits on headcount.",
        image: "https://images.pexels.com/photos/7688336/pexels-photo-7688336.jpeg?auto=compress&cs=tinysrgb&fit=crop&h=800&w=1100",
    ...
    },
    {
        ...
        intro: "The strength of every organisation lies in its people. Our permanent recruitment blends human insight with smart tooling to find hires who define your culture, drive your vision and elevate your success.",
    ...
    },
    {
        ...
        intro: "Through strategic consulting, talent development and coaching, we help organisations evolve their people strategy for the long term — so your teams don't just adapt to change, they thrive on it.",
  ...
  <section class="border-y border-ink/10 bg-cream py-24">
    <div class="container-x">
      ...
      <div class="mt-14 grid gap-6 md:grid-cols-3">
        ${c.offerings
        .map((o, i) => rv(`<div class="card-hover h-full rounded-[1.75rem] border border-ink/10 bg-paper p-8">
    ...
    <div class="grid gap-14 lg:grid-cols-2">
      <div>
        ...
        <div class="mt-10 space-y-4">
          ${c.steps
        .map((s, i) => rv(`<div class="card-hover flex gap-6 rounded-3xl border border-ink/10 bg-cream p-6">
                  <span class="font-display text-3xl font-semibold text-accent">${s.nr}</span>
                  <div>
...
export function privacyPage() {
    ...
    <div class="mt-12 space-y-8">
      ${sections
        .map((s, i) => rv(`<section class="rounded-3xl border border-ink/10 bg-cream p-7">
